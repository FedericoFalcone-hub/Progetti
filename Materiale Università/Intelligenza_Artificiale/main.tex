...
\end{itemize}
Se il numero di stati possibili è molot grande ($>10^6$) la convergenza risulta \textbf{molto lenta}. Un agente che deve imparare a giocare a Go fronteggia un numero di coppie stato-azione proibitivo.
...
Sfruttando l'informazione racchiusa nel dataser costruiamo una funzione $h$ che approssima $f$. Usiamo $h$ su nuovi input $x_new$ di cui non ci è stato dato l'output.
