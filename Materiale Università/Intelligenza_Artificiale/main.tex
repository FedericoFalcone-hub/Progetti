...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\linewidth]{ricerca1.png}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\linewidth]{UCS.png}
\end{figure}
...
\begin{figure}[H]
    \includegraphics[width=0.5\linewidth]{Ottimilita_UCS.png}
\end{figure}
...
\begin{figure}[H]
    \includegraphics[width=1\linewidth]{UCS_conEXL.png}
\end{figure}

\subsubsection{Implementazione}
\begin{figure}[H]
    \includegraphics[width=1\linewidth]{implementazione_UCS.png}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.4\linewidth]{A_conEXL.png}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.25\linewidth]{consistenza.png}
\end{figure}
...
\begin{enumerate}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.25\linewidth]{assimilitaA.png}
    \end{figure}
\end{enumerate}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.50\linewidth]{OttimalitaA2.png}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\linewidth]{creareEuristica.png}
\end{figure}
...
\begin{figure} [H]
  \centering\includegraphics[width=0.75\linewidth]{rilassamento.png}
\end{figure}
\textbf{Idea}:
\begin{enumerate}
