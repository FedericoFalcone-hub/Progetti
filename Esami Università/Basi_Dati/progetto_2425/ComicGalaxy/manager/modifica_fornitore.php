...
if (isset($_POST['save'])) {
    ...
    if ($result === true) {
        ...
        $_SESSION['error_msg'] = "Errore durante l'aggiornamento: " . $result;
    }
    ...
    <div class="container my-5">
        ...
        <form method="POST" class="mx-auto" style="max-width:500px;">
            <div class="mb-3">
                ...
                <input type="text" name="nome" class="form-control" value="<?= $fornitore['nome'] ?>" required>
            </div>

            <div class="mb-3">
                <label class="form-label">Partita IVA</label>
                <input type="text" name="f_p_iva" class="form-control" value="<?= $p_iva ?>" required minlength="13" maxlength="13">
            </div>

            <div class="mb-3">
                <label class="form-label">Email</label>
                <input type="email" name="mail" class="form-control" value="<?= $fornitore['mail'] ?>" required>
            </div>

            <div class="mb-3">
                <label class="form-label">Telefono</label>
                <input type="text" name="telefono" class="form-control" value="<?= $fornitore['telefono'] ?>">
            </div>

            <div class="mb-3">
                <label class="form-label">Via</label>
                <input type="text" name="via" class="form-control" value="<?= $fornitore['via'] ?>">
            </div>

            <div class="mb-3">
                <label class="form-label">Civico</label>
                <input type="number" name="civico" class="form-control" value="<?= $fornitore['civico'] ?>">
            </div>

            <div class="mb-3">
                <label class="form-label">Città</label>
                <input type="text" name="citta" class="form-control" value="<?= $fornitore['citta'] ?>">
            </div>
