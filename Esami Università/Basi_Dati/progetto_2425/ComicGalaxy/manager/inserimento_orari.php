...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    if (!isset($error_msg)) {
        ...
        if ($result === true) {
            ...
            $error_msg = "Errore durante il salvataggio degli orari: " . $result;
        }
    }
}
?>
...
<head>
    <meta charset="UTF-8">
    <title>Inserisci Orari - <?= $negozio['nome'] ?></title>
...
<body>
    ...
    <div class="container my-5">
        ...
        <h2 class="text-center text-primary mb-4">🕒 Inserisci Orari - <?= $negozio['nome'] ?></h2>
