                ...
                <table class="table table-striped table-bordered">
                    ...
                    <tbody>
                        ...
                        <tr class="table-warning fw-bold">
                            ...
                            <td>
                                <?php $sconto_applicato = $totale_prodotti * ($sconto / 100); 
                                    if($sconto_applicato>100){
                                        $sconto_applicato=100;
                                    }
                                ?>
                                - €<?= number_format($sconto_applicato, 2) ?>
                            </td>
                        </tr>

                        <!-- Totale finale -->
                        <?php
                        $totale_finale = $totale_prodotti - $sconto_applicato;
                        ?>
