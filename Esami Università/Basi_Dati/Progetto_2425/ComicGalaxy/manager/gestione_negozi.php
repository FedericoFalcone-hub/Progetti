...
if (isset($_POST['crea_negozio'])) {
    ...
    if ($result === true) {
        ...
        $_SESSION["error"] = "Errore nella creazione del negozio: " . htmlspecialchars($result);
    }
    }
    $negozi = getNegozi();
            ...
            <div class="col-auto">
                ...
                <select name="manager" class="form-select" style="min-width:150px;" required>
                    ...
                    <?php foreach ($manager as $m): ?>
                        <option value="<?= htmlspecialchars($m['mail']) ?>">
            ...
            <table class="table table-striped table-hover table-bordered mb-0">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><?= htmlspecialchars($n['manager'] ?? '-') ?></td>
                        <td>
