...
// Se non esiste o non appartiene al negozio → blocca
if (!$fattura) {
...
<div class="container my-5">
    ...
    <h2 class="text-primary text-center mb-4">
        Dettaglio Fattura #<?= htmlspecialchars($fattura["id"]) ?>
    </h2>
    ...
    <div class="card shadow-sm mb-4">
        ...
        <div class="card-body">
            <p><strong>Data:</strong> <?= htmlspecialchars($fattura["data_acquisto"]) ?></p>
            <p><strong>Sconto applicato:</strong> <?= htmlspecialchars($fattura["sconto"]) ?>%</p>
            <p><strong>Importo totale:</strong> €<?= number_format($fattura["totale"], 2) ?></p>
            <p><strong>Cliente:</strong> <?= htmlspecialchars($fattura["nome"] . " " . $fattura["cognome"]) ?></p>
            <p><strong>Codice fiscale:</strong> <?= htmlspecialchars($fattura["cf_cliente"]) ?></p>
        </div>
    </div>
