...
if (isset($_POST['richiedi_tessera'])) {
    ...
    if ($result === true) {
        ...
        $error_msg = "Errore durante la creazione della tessera: " . htmlspecialchars($result);
    }
}
...
if (isset($_POST['esegui_ordine'])) {
    ...
    if ($result === true) {
        ...
        $_SESSION['error_msg'] = "Errore nell'esecuzione dell'ordine: " . htmlspecialchars($result);
    }
...
<body>
    ...
    <div class="container mt-5">
        ...
        <?php else: ?>
            ...
            <div class="card shadow-sm mt-4">
                <div class="card-header fw-bold">Sconti & Tessera Punti</div>
                <div class="card-body">
                    <?php if (!$tessera): ?>
