...
if (isset($_POST['rinnova'])) {
    ...
    if ($result === true) {
        ...
        $_SESSION["error"] = "Errore durante il rinnovo della tessera: " . htmlspecialchars($result);
    }
        ...
        <?php else: ?>
            ...
            <div class="card shadow-sm mt-4">
                ...
                <div class="card-body">
                    ...
                    <p><strong>Codice Tessera:</strong> <?= htmlspecialchars($tessera['id']) ?></p>
                    <p><strong>Negozio Emissione:</strong> <?= htmlspecialchars($tessera['nome_negozio']) ?></p>
                    <p><strong>Punti Attuali:</strong> <?= htmlspecialchars($tessera['saldo']) ?></p>
                    <p><strong>Data Creazione:</strong> <?= htmlspecialchars($tessera['data_emissione']) ?></p>
                    <p><strong>Data Scadenza:</strong> <?= htmlspecialchars($tessera['data_scadenza']) ?></p>
                    <p>
                        <strong>Stato:</strong>
                    ...
                    <?php if ($stato === "Scaduta"): ?>
                        <form method="post" class="mt-3">
                            <input type="hidden" name="cf_cliente" value="<?= htmlspecialchars($tessera['cf']) ?>">
                    ...
                    <?php if (isset($tessera['negozio'])): ?>
                        <p class="mt-3"><strong>Negozio di Emissione:</strong> <?= htmlspecialchars($tessera['negozio']) ?></p>
                    <?php endif; ?>
