...
// Controllo accesso: solo clienti
                    ...
                    <table class="table table-striped table-bordered">
                        ...
                        <tbody>
                            <?php foreach ($acquisti as $acquisto): ?>
                                <tr>
                                    <td><a href="dettaglio_acquisto.php?id=<?= htmlspecialchars($acquisto['id']) ?>&sconto=<?= htmlspecialchars($acquisto['sconto']) ?>">
                                            <?= htmlspecialchars($acquisto['id']) ?>
                                        </a></td>
                                    <td><?= htmlspecialchars($acquisto['data_acquisto']) ?></td>
                                    <td><?= htmlspecialchars($acquisto['nome_negozio']) ?></td>
                                    <td><?= htmlspecialchars($acquisto['sconto']) ?>%</td>
